...
export function Hero({ onGetStarted, onLearnMore }: HeroProps) {
    ...
    switch (activeStep) {
        ...
        return (
          <div className="flex flex-col h-full bg-slate-950 text-white p-5 justify-between">
            <div className="flex items-center justify-between border-b border-slate-800 pb-3">
              <span className="text-xs font-semibold text-blue-450">EMI Calculator</span>
            ...
            <div className="my-auto space-y-4">
              ...
              <div className="bg-blue-950/40 p-3 rounded-lg border border-blue-900/30 text-center space-y-0.5">
                <span className="text-[9px] text-blue-400 font-semibold block uppercase">Estimated EMI</span>
                <span className="text-lg font-black text-white">$512.91</span>
                <span className="text-[8px] text-slate-400 block">per month</span>
              </div>
            </div>
            <Button size="sm" className="w-full bg-blue-600 hover:bg-blue-700 text-[11px] h-8 rounded-lg text-white font-semibold">
              Apply Now
            </Button>
          </div>
        );
      case 1:
        return (
          <div className="flex flex-col h-full bg-slate-950 text-white p-5 justify-between">
            <div className="flex items-center justify-between border-b border-slate-800 pb-3">
              <span className="text-xs font-semibold text-blue-450">AI Assistant</span>
            ...
            <div className="my-auto space-y-3 flex-1 overflow-y-auto py-2">
              ...
              <div className="bg-blue-900/20 p-2.5 rounded-lg border border-blue-800/30 max-w-[85%] space-y-1">
            ...
            <div className="flex gap-1.5 border-t border-slate-800 pt-2">
              ...
              <div className="w-6 h-6 bg-blue-700 rounded-md flex items-center justify-center text-white text-[10px] font-bold">
                ▲
              </div>
            </div>
          </div>
      ...
      default:
        return (
          <div className="flex flex-col h-full bg-slate-950 text-white p-5 justify-between">
            <div className="flex items-center justify-between border-b border-slate-800 pb-3">
              <span className="text-xs font-semibold text-blue-450">Loan Checklist</span>
  ...
  return (
    <div className="overflow-x-hidden bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-100 min-h-screen">
      
      {/* 1. HERO SECTION */}
      <section className="relative pt-32 pb-20 px-4 md:px-8 max-w-7xl mx-auto">
        <div className="absolute top-0 right-0 -z-10 w-[500px] h-[500px] bg-blue-500/10 dark:bg-blue-900/10 rounded-full filter blur-3xl" />
        <div className="absolute top-20 left-10 -z-10 w-[300px] h-[300px] bg-teal-500/10 dark:bg-teal-900/10 rounded-full filter blur-3xl" />

        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          {/* Left Column - Copy content */}
          <div className="space-y-8 lg:col-span-7">
            <div className="inline-flex items-center gap-2 px-3 py-1 border border-slate-200 dark:border-slate-800 bg-blue-50/50 dark:bg-blue-950/25 rounded-full text-xs font-semibold text-blue-700 dark:text-blue-450">
              <Shield className="h-3 w-3 text-blue-600" />
              <span>Bhalchandra Finance • Your Success Partner</span>
            </div>

            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-slate-950 dark:text-white leading-tight">
              Take Control of Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-teal-600 dark:from-blue-400 dark:to-teal-400">Financial Future</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              <Button
                ...
                className="bg-blue-700 hover:bg-blue-800 text-white rounded-full px-8 py-6 text-base font-semibold shadow-lg shadow-blue-700/15 flex items-center gap-2 border border-transparent"
              >
                Get Started Today
              ...
              <Button
                ...
                size="lg"
                onClick={onLearnMore}
                className="border-slate-250 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-900 text-slate-700 dark:text-slate-200 rounded-full px-8 py-6 text-base font-semibold bg-transparent"
              >
                Learn More
              </Button>
            </div>
            ...
            {/* Trust partners */}
            <div className="pt-6 border-t border-slate-200/60 dark:border-slate-850/60">
          ...
          <div className="relative lg:col-span-5 flex justify-center">
            <div className="relative w-full max-w-[420px]">
              <div className="absolute inset-0 bg-gradient-to-tr from-blue-500/20 to-teal-500/20 rounded-3xl filter blur-xl opacity-70" />
              <img 
              ...
              {/* Overlapping Trust badge removed */}
            </div>
          </div>
        </div>
      </section>
      ...
      {/* 2. FEATURES SECTION */}
      <section className="py-24 bg-slate-100/50 dark:bg-slate-900/30 border-y border-slate-200/50 dark:border-slate-900/60">
        <div className="max-w-7xl mx-auto px-4 md:px-8 space-y-16">
          <div className="text-center max-w-3xl mx-auto space-y-4">
            <span className="px-3 py-1 border border-slate-200 dark:border-slate-850 bg-blue-50/50 dark:bg-blue-950/20 rounded-full text-xs font-semibold text-blue-700 dark:text-blue-400">
              Simple, Smart, Financial Services
            </span>
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-slate-955 dark:text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-200/40 dark:border-slate-850/80 rounded-2xl overflow-hidden shadow-md flex flex-col group hover:shadow-lg transition duration-200">
              <div className="p-6 space-y-4 flex-1">
                <div className="w-10 h-10 bg-blue-50 dark:bg-blue-950/40 text-blue-700 dark:text-blue-450 rounded-xl flex items-center justify-center border border-blue-100/30">
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-200/40 dark:border-slate-850/80 rounded-2xl overflow-hidden shadow-md flex flex-col group hover:shadow-lg transition duration-200">
              <div className="p-6 space-y-4 flex-1">
                <div className="w-10 h-10 bg-blue-50 dark:bg-blue-950/40 text-blue-700 dark:text-blue-455 rounded-xl flex items-center justify-center border border-blue-100/30">
          ...
          <div className="flex justify-center pt-4">
            <Button
              onClick={onLearnMore}
              className="bg-blue-700 hover:bg-blue-800 text-white rounded-full px-6 py-5 font-semibold text-sm flex items-center gap-2 shadow-sm"
            >
              Explore Services
      ...
      <section className="py-20 px-4 md:px-8 max-w-7xl mx-auto">
        <div className="bg-slate-900 dark:bg-slate-900/60 text-white rounded-3xl p-8 lg:p-16 shadow-2xl relative overflow-hidden">
          <div className="absolute top-0 right-0 -z-10 w-[400px] h-[400px] bg-blue-700/15 rounded-full filter blur-3xl" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-8">
              <div className="space-y-4">
                <span className="px-3 py-1 border border-slate-800 bg-blue-950/40 rounded-full text-xs font-semibold text-blue-400">
                  How it Works
                </span>
                ...
                {stepsData.map((step, idx) => (
                  <div 
                    ...
                    className={`flex gap-4 p-4 rounded-2xl border cursor-pointer transition duration-200 ${
                      activeStep === idx 
                        ? "bg-slate-850/80 border-blue-500/50 shadow-md shadow-blue-700/5" 
                  ...
                  >
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-xs shrink-0 transition ${
                      activeStep === idx ? "bg-blue-700 text-white" : "bg-slate-800 text-slate-400"
                    }`}>
                      {idx + 1}
                    </div>
                    <div className="space-y-1">
              ...
              <div className="pt-2">
                <Button
                  onClick={onGetStarted}
                  className="bg-white hover:bg-slate-100 text-slate-900 rounded-full px-8 py-5 font-semibold text-sm flex items-center gap-2 shadow-md"
                >
                  Apply Online
      ...
      <section className="py-24 bg-slate-105/30 dark:bg-slate-900/10 border-y border-slate-200/50 dark:border-slate-900/60">
        <div className="max-w-7xl mx-auto px-4 md:px-8 space-y-16">
          <div className="text-center max-w-3xl mx-auto space-y-4">
            <span className="px-3 py-1 border border-slate-200 dark:border-slate-800 bg-blue-50/50 dark:bg-blue-950/20 rounded-full text-xs font-semibold text-blue-700 dark:text-blue-400">
              Why Choose Us
            </span>
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-slate-955 dark:text-white">
              Why Thousands Trust Bhalchandra Finance
            </h2>
            <p className="text-slate-655 dark:text-slate-350 text-sm sm:text-base">
              Experience a modern, automated financial platform built for simplicity, high security, and deep planning analytics.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl border border-slate-200/40 dark:border-slate-800/80 shadow-sm hover:shadow-md transition">
              <div className="w-10 h-10 bg-blue-50 dark:bg-blue-950/40 text-blue-700 dark:text-blue-400 rounded-xl flex items-center justify-center border border-blue-100/30 mb-6">
                <Shield className="h-5 w-5" />
              </div>
              <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-3">Bank-level Security</h3>
            ...
            <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl border border-slate-200/40 dark:border-slate-800/80 shadow-sm hover:shadow-md transition">
              ...
              <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-3">Expert Consultation</h3>
              <p className="text-xs sm:text-sm text-slate-655 dark:text-slate-400 leading-relaxed">
            ...
            <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl border border-slate-200/40 dark:border-slate-800/80 shadow-sm hover:shadow-md transition">
              <div className="w-10 h-10 bg-blue-50 dark:bg-blue-950/40 text-blue-700 dark:text-blue-450 rounded-xl flex items-center justify-center border border-blue-100/30 mb-6">
                <Calculator className="h-5 w-5" />
              </div>
      ...
      {/* 5. FAQ SECTION */}
      <section className="py-20 bg-slate-100/50 dark:bg-slate-900/30 border-y border-slate-200/50 dark:border-slate-900/60">
        <div className="max-w-4xl mx-auto px-4 md:px-8 space-y-12">
          <div className="text-center space-y-3">
            <span className="px-3 py-1 border border-slate-200 dark:border-slate-800 bg-blue-50/50 dark:bg-blue-950/20 rounded-full text-xs font-semibold text-blue-700 dark:text-blue-400">
              FAQ
            </span>
            <h2 className="text-3xl font-bold tracking-tight text-slate-955 dark:text-white">
          ...
          <div className="space-y-4">
            {faqData.map((item, index) => (
              <div 
                key={index} 
                className="bg-white dark:bg-slate-900 border border-slate-200/40 dark:border-slate-800/80 rounded-xl overflow-hidden shadow-sm"
              >
                <button
                  onClick={() => toggleFaq(index)}
                  className="w-full flex items-center justify-between p-5 text-left font-semibold text-sm sm:text-base text-slate-900 dark:text-white hover:bg-slate-50/50 dark:hover:bg-slate-800/20 transition"
                >
                  <span>{item.q}</span>
                  {openFaqIndex === index ? (
                    <ChevronUp className="h-5 w-5 text-blue-700 shrink-0" />
                  ) : (
                    <ChevronDown className="h-5 w-5 text-slate-405 shrink-0" />
                  )}
                </button>
                
                {openFaqIndex === index && (
                  <div className="p-5 pt-0 text-xs sm:text-sm text-slate-600 dark:text-slate-400 border-t border-slate-100 dark:border-slate-800 leading-relaxed bg-slate-50/20 dark:bg-slate-950/10">
                    {item.a}
                  </div>
                )}
              </div>
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 md:px-8">
        <div className="bg-gradient-to-br from-slate-900 to-blue-950 text-white rounded-3xl p-8 lg:p-14 shadow-2xl relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2 max-w-md">
                <input 
                  ...
                  className="bg-slate-800/60 border border-slate-700/60 text-white rounded-full px-5 py-3.5 text-xs sm:text-sm focus:outline-none focus:border-blue-500 flex-1 w-full"
                  required
                />
                <Button 
                  onClick={onGetStarted}
                  className="bg-blue-700 hover:bg-blue-800 text-white rounded-full px-6 py-3.5 text-xs sm:text-sm font-semibold shadow-md shadow-blue-700/20 w-full sm:w-auto flex items-center gap-1.5 justify-center"
                >
            ...
            <div className="lg:col-span-5 flex justify-center relative">
              <div className="relative w-full max-w-[340px]">
                ...
                />
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 -z-10 w-[240px] h-[240px] bg-blue-500/20 rounded-full filter blur-3xl opacity-60" />
              </div>
            </div>
          </div>
        </div>
