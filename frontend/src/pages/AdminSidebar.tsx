  ...
  return (
    ...
    >
      ...
      <div className="h-16 flex items-center justify-between px-4 border-b border-border dark:border-border/60">
        ...
        {isCollapsed && (
          <Building2 className="h-6 w-6 text-primary mx-auto shrink-0 animate-pulse" />
        )}
        ...
        {isCollapsed && (
          <button
            onClick={onToggle}
            className="absolute left-14 top-4 bg-card dark:bg-slate-955 border border-border dark:border-border p-1 rounded-full shadow-md text-muted-foreground hover:text-muted-foreground hover:scale-105 transition-all z-50"
                  ...
                  <button
                    ...
                    className={`w-full flex items-center justify-center p-3 rounded-xl transition-all duration-200 relative group ${
                      isActive
                        ...
                        : "text-muted-foreground hover:text-primary hover:bg-muted/30 dark:text-muted-foreground dark:hover:bg-slate-900"
                    }`}
                  >
                    {isActive && (
          ...
          return (
            <button
              ...
              className={`w-full flex items-center gap-3.5 p-3 rounded-xl text-left transition-all duration-200 relative group ${
                isActive
                  ? "bg-primary/15 text-primary font-bold shadow-sm border border-primary/20"
                  : "text-muted-foreground hover:text-primary hover:bg-muted/30 dark:text-slate-300 dark:hover:bg-slate-900"
              }`}
            >
              {isActive && (
                <span className="absolute left-0 top-3 bottom-3 w-1 bg-primary rounded-r" />
