...
app.get("/api/admin/users", (req, res) => {
  res.json({
    users: [
      { id: "u1", name: "Ritesh Suryawanshi", email: "riteshsuryawanshi160.com", username: "Ritesh", role: "user", createdAt: "2024-01-12" },
      { id: "u2", name: "Nikita Sontakke", email: "nikitasontakke581.com", username: "Nikita", role: "user", createdAt: "2024-03-20" },
    ],
  });
});

app.get("/api/admin/user-analysis/:id", (req, res) => {
  res.json({
    predictions: [
      { month: "Oct", predictedLoans: 9, predictedRepayment: 7 },
      { month: "Nov", predictedLoans: 11, predictedRepayment: 9 },
      { month: "Dec", predictedLoans: 14, predictedRepayment: 11 },
      { month: "Jan", predictedLoans: 16, predictedRepayment: 12 },
      { month: "Feb", predictedLoans: 17, predictedRepayment: 13 },
      { month: "Mar", predictedLoans: 19, predictedRepayment: 15 },
    ],
  });
});
